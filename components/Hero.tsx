    ...
    <section id="top" className="aurora grid-bg relative overflow-hidden border-b border-line">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-8 px-4 py-14 md:grid-cols-2 md:py-20">
        ...
        <div key={i} className="hero-in">
          ...
          <p className="mt-4 max-w-md text-base text-fog sm:text-lg">{s.subtitle}</p>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div key={`art-${i}`} className="hero-in art-halo relative flex h-72 w-72 items-center justify-center rounded-3xl border border-line bg-panel/40 md:h-96 md:w-96">
